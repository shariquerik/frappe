...
import {
  ...
  setDesktopEl, setDockEl, desktopRef, syncDesktopSize, startIconDrag, iconDragState, dragGhost, droppedOnDock, dockDrop,
} from './geometry'
import {
...
export function useOS() {
  return {
    ...
    startDrag, startResize, onPointerMove, onPointerUp, startIconDrag, iconDragState, dragGhost, droppedOnDock, dockDrop,
    toggleSidebar, openAppSettings, closeAppSettings, setAppSettingsPane, enterSplit, exitSplit,
