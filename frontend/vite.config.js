...
export default defineConfig(({ command }) => ({
  ...
  plugins: [
    ...
    ...frappeui({ lucideIcons: true, frappeProxy: true, jinjaBootData: false, buildConfig: false }),
    vue(),
  ...
  server: {
    ...
    // sibling repo.
    fs: { allow: [fileURLToPath(new URL('..', import.meta.url)), ...manifest.map((app) => app.source_dir)] },
  },
}))
