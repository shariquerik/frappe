...
-->
<template>
	<!-- PROTOTYPE: under `?variant=`, frappe-ui's shell components draw the same state; nothing below changes. -->
	<ShellFrame
		v-if="variant"
		:variant="variant"
		:rail="navigation.rail"
		:rail-sections="sections.rail"
...
import { variant } from "./shellVariant";
